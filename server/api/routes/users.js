...
const {getCollectionByUsername, insert, update, remove, updateUsername, removeUser} = require("../mongoData");
const {responseGet} = require("../headers");

/* GET users section. */
router.get('/', function (req, res, next) {
    getCollectionByUsername('users').then(data => responseGet(res, data));
});
